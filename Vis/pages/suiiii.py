...
if fpl_id and gw_complete_list:
        ...
        for index, row in df.iterrows():
            ...
            bench_y = 100+pitch_length - 2.5 * zone_height  # Position bench at the bottom of the figure
        ...
        for i, row in enumerate(df_bench.itertuples()):
                ...
                ax.text(x_bench, bench_y - 8, player_name, fontsize=6, ha='center', color='black')

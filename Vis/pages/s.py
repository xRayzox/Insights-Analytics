...
league_df['Form'] = league_df['form'].str.replace('W', ' ', regex=False).str.replace('L', ' ', regex=False).str.replace('D', ' ', regex=False)
...
table = Table(
    ...
    footer_divider=True,
    textprops={"fontsize": 12},  # Adjust fontsize for Streamlit
